import 'package:Service/src/Models/deals.dart';
...
class _FourthlistState extends State<Fourthlist> {
  ...
  addDealItem() {
    ...
    deal.add(
        deals("assets/dryclean.jpg", 'Dry Clean Services', 'Starting @99'));
    deal.add(deals("assets/foood.jpg", 'Foods and Beverages', 'Extra 100 Off'));
  }
